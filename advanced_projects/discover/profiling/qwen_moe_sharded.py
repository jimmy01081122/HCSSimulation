...
def main():
    ...
    print("=========================================================")
    print("  Qwen1.5-MoE-A2.7B Sharded GSM8K Profiling Pipeline     ")
    print("=========================================================")
    ...
    print(f"Loading sharded model: {model_id} on CPU with disk offload...")
    t0 = time.time()
    
    offload_dir = "/home/a/discover/profiling/offload_qwen_sharded"
    os.makedirs(offload_dir, exist_ok=True)
    
    # Restrict CPU RAM usage to 8GiB to guarantee safety under WSL2 limits
    max_mem = {"cpu": "8GiB"}
    
    # Load the official model shard-by-shard to prevent memory spikes
