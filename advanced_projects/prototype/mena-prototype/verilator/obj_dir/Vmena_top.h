...
#ifndef VERILATED_VMENA_TOP_H_
#define VERILATED_VMENA_TOP_H_  // guard

#include "verilated.h"

class Vmena_top__Syms;
class Vmena_top___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vmena_top VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vmena_top___024root* const rootp;
    ...
    explicit Vmena_top(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vmena_top(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vmena_top();
  private:
    VL_UNCOPYABLE(Vmena_top);  ///< Copying not allowed
