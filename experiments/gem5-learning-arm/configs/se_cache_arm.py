...
"""
ARM gem5 SE Mode - Classic Cache Configuration Example
檔案功能簡述: 
  示範如何在 ARM gem5 中建立具有經典快取層級的系統
  學習目標:
    - 理解快取階層的配置方式
...
使用方式:
  gem5.opt --outdir=results/se_cache configs/se_cache_arm.py

TODO 任務:
  1. 修改 L1 快取大小 (目前: 32KB) 並觀察效能變化
  2. 修改 L2 快取大小 (目前: 256KB) 並測試
  3. 添加 L3 快取並觀察三層結構的影響
  4. 比較不同 associativity 設定的效果
"""
...
def create_arm_cache_system():
    """
    建立 ARM SE mode 系統,包含經典快取架構
    ...
    # TODO: 完成快取配置
    # 提示: 使用 Cache class 定義 L1/L2 快取參數
    ...
    l1i_cache.size = '32KB'
    l1i_cache.assoc = 2
    # TODO: 設定其他 L1 指令快取參數 (hit_latency, response_latency 等)
...
def main():
    ...
    # TODO: 步驟 2 - 整合快取架構
    # l1i, l1d, l2 = create_arm_cache_system()
    # 提示: 需要將快取連接到 CPU 與系統匯流排
    
    # TODO: 步驟 3 - 載入並執行程式
    # 提示: 使用 obtain_resource() 取得預編譯的 ARM 程式
    # 範例: arm_binary = obtain_resource("arm-ubuntu-18.04-hello")
