...
"""
ARM gem5 SE Mode - CPU Model Comparison Configuration
檔案功能簡述: 
...
使用方式:
  gem5.opt --outdir=results/cpu_atomic configs/se_cpu_select_arm.py --cpu=ATOMIC
  gem5.opt --outdir=results/cpu_timing configs/se_cpu_select_arm.py --cpu=TIMING
  gem5.opt --outdir=results/cpu_o3 configs/se_cpu_select_arm.py --cpu=O3
...
def parse_arguments():
    ...
    """
    parser = argparse.ArgumentParser(description="ARM CPU Comparison Config")
...
def main():
    ...
    # arm_binary = obtain_resource("arm-ubuntu-18.04-hello")
