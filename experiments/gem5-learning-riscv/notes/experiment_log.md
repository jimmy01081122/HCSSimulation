# RISC-V gem5 Experiment Notes Template

## 實驗 1: Hello World 基本驗證

### 日期: ___________
### 目標:
驗證 RISC-V gem5 環境正確安裝並能執行最基本的 SE mode 模擬

### 步驟:
- [ ] 檢查 gem5 RISC-V 二進位檔案: `ls -l ../../../gem5/build/RISCV/gem5.opt`
- [ ] 執行: `../../../gem5/build/RISCV/gem5.opt --outdir=results/hello configs/se_hello_riscv.py`
...
RISC-V 與 ARM 的比較結果是否相同? ____________
...
### 效能對比:
- ATOMIC: ARM ______ vs RISC-V ______
- TIMING: ARM ______ vs RISC-V ______
- O3: ARM ______ vs RISC-V ______
...
- 教學文件: ../../prompt_generated_gem5_tutorial_RISCV.md
