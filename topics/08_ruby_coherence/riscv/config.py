...
processor = SimpleProcessor(cpu_type=CPUTypes.TIMING, isa=ISA.RISCV, num_cores=2)
...
print("Running Multi-core RISC-V Ruby Cache Coherence simulation...")
simulator.run()
