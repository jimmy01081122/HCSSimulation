"""
簡述: 使用底層 m5.objects API 手動配置一個 RISC-V SE 模式系統，不使用 gem5 標準函式庫。
...
# 8. 設定工作負載與進程
process = Process()
process.executable = "/work/gem5/tests/test-progs/hello/bin/riscv/linux/hello"
