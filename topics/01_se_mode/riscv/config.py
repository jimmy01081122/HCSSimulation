"""
簡述: 本組態檔案使用 gem5 標準函式庫建置一個基礎的 RISC-V SE 模式單核心系統。
...
# TODO: 4. 建立 SimpleProcessor，微架構為 TIMING, 核心數 1, 架構為 RISCV
...
# TODO: 6. 設定 SE 模式工作負載為 RISC-V Hello World 二進位檔
# 檔案路徑: /work/gem5/tests/test-progs/hello/bin/riscv/linux/hello
...
simulator.run()
print("RISCV SE simulation finished successfully.")
